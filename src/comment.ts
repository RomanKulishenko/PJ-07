import { IReplyData } from "./myComment";
...
export class Comment {
  ...
  render(isFavorites: boolean): string {
    return `
    <div class="comment${this.isReply ? " comment--answer" : ""}${
      isFavorites ? " comment--favorite" : ""
    }" id="${this.id}">
        <div class="comment__avatar"><img src="${this.photo}" alt="ava${
      this.id
    }" width="61" height="61"></div>
      ...
      this.replyData.name
            ...
            <div class="comment__button comment__button--answer ${
              this.isReply || isFavorites ? "hidden" : ""
            }">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="800px" width="800px" version="1.1" id="Layer_1" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve"><path d="M185.2,128.6V19.7L0,204.9l185.2,185.2V281.1c152.5,0,250.5,0,326.8,217.9C512,390.1,522.9,128.6,185.2,128.6z"/></svg>
                Ответить
            </div>
            <div class="comment__button comment__button--favorite${
            ...
            <div class="comment__button comment__button--rate">
                ...
                <span class="comment__button-num" ${
                  this.rating >= 0
                    ? ' style="color: #8AC540;"'
                    : ' style="color: red;"'
                }>${this.rating}</span>
