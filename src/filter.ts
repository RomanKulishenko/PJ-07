...
export class Filter {
  public updateCountComments(): void {
    ...
    const filterCommentsNum: HTMLElement = document.querySelector(
      ".filter__btn-num"
    ) as HTMLElement;
  ...
  public clickBtn(): void {
    const buttonsContainer: HTMLElement = document.querySelector(
      ".filter"
    ) as HTMLElement;
    ...
    function showComments(button: HTMLElement) {
      ...
      document
        .querySelector(".filter__btn--favorites")
    ...
    function showFavorites(button: HTMLElement) {
      button.classList.add("active");
      document
        .querySelector(".filter__btn--comments")
        ?.classList.remove("active");
    ...
    function toggleAscending(event: Event) {
      ...
      const favoriteStatus: boolean = document
        .querySelector(".filter__btn--favorites")
        ?.classList.contains("active") as boolean;
  ...
  public toggleRatingList(): void {
    const selection: HTMLElement = document.querySelector(
      ".selection"
    ) as HTMLElement;
    ...
    function toggleList(event: Event): void {
      const target = event.target as HTMLElement;
      const selectionList: HTMLElement = document.querySelector(
        ".selection__list"
      ) as HTMLElement;
      ...
      document.querySelectorAll(".selection__list-item").forEach((item) => {
        item.addEventListener("click", (event) => {
          ...
          selectionList.classList.remove("active");
          document
            .querySelector(".selection__btn")
            ?.classList.remove("actived");
          const btn: HTMLElement = (
            item.closest(".selection__item") as HTMLElement
          ).querySelector(".selection__btn span") as HTMLElement;
			...
			<div class="selection">
				<div class="selection__item">
					...
					<div class="selection__list"> 
						...
						<div class="selection__list-item" data-type="actual">
							<svg xmlns="http://www.w3.org/2000/svg" version="1.1" inkscape:version="0.48.4 r9939" width="800px" height="800px" viewBox="0 0 1200 1200" enable-background="new 0 0 1200 1200" xml:space="preserve"><path inkscape:connector-curvature="0" d="M1004.237,99.152l-611.44,611.441L194.492,512.288L0,706.779  l198.305,198.306l195.762,195.763L588.56,906.355L1200,294.916L1004.237,99.152z"/></svg>
